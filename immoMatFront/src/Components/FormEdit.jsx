...
export const FormEdit= () => {
    ...
    return <>
        <div className="bg-gray-100 p-20 rounded-md w-[40em] flex justify-center items-center">
                <form onSubmit={(e) => updateMateriel(e, id)} className="max-w-sm mx-auto" encType="multipart/form-data">
                    <div>
                    ...
                    <div className="mt-10">
                        <button type="submit" className="w-full p-4 text-white bg-teal-600 rounded-lg hover:bg-teal-500 dark:text-white dark:bg-teal-400">Update</button>
                    </div>
                </form>
            </div>
    </>
